...
## Dataset
- **Source**: Retail Sales dataset (can be obtained from sources like Kaggle or company data).
(https://www.kaggle.com/datasets/pavitpreetsingh/relience-sales-data)

  
## Setup and Installation
1. **Power BI**: Install **Power BI Desktop** from [Power BI Downloads](https://powerbi.microsoft.com/desktop/).
